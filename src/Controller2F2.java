...
public class Controller2F2 {
    public static void main(String[] args) {
        PetriNet pn = new PetriNet();
        pn.PetriNetName = "Controller2F2";
        pn.SetName("Controller2F2");
        pn.NetworkPort = 1082;
        ...
        p6.SetName("OP3");
        p6.Value = new TransferOperation("localhost", "1080" , "P_TL3");
        pn.PlaceList.add(p6);

        DataTransfer p7 = new DataTransfer();
        p7.SetName("OP4");
        p7.Value = new TransferOperation("localhost", "1080" , "P_TL4");
        pn.PlaceList.add(p7);
        ...
        System.out.println("Controller2F2 started \n ------------------------------");
        pn.Delay = 2000;
        // pn.Start();
